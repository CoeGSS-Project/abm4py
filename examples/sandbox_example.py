...
if __name__ == '__main__':
    ...
    def computeCars():
        ...
        # for the agent nodes
        for agent in earth.iterAgents.byType(_agent):
            #print agent.nID
            nBrownCars = 0
            nGreenCars = 0
        ...
        # for spatial nodes
        for location in earth.iterAgents.byType(_location):
            nCars = 0
    ...
    def simulationStep(deltaCars):
        ...
        for loc in earth.iterAgents.byType(_location):
    ...
    for ag in earth.iterAgents.byType(_agent):
