...
from lib_abm4py import World, Agent
import numpy as np
...
if __name__ == '__main__':
    ...
    def computeCars():
        ...
        # for the agent nodes
        for agent in earth.getAgentsByType(_agent):
            #print agent.nID
            nBrownCars = 0
            nGreenCars = 0
        ...
        # for spatial nodes
        for location in earth.getAgentsByType(_location):
            nCars = 0
    ...
    def simulationStep(deltaCars):
        ...
        for loc in earth.getAgentsByType(_location):
