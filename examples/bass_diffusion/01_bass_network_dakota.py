...
#%% this are parameters that can be set by dakota
world.setParameter('imitation', 15)
world.setParameter('innovation', 0.2)
...
for iAgent in range(N_AGENTS): 
    ...
    imit = random.normalvariate(world.getParameter('imitation'), 2)
